...
CREATE TABLE "new_Comentario" (
    ...
    CONSTRAINT "Comentario_id_post_fkey" FOREIGN KEY ("id_post") REFERENCES "Post" ("id_post") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Favoritos" (
    ...
    CONSTRAINT "Favoritos_id_post_fkey" FOREIGN KEY ("id_post") REFERENCES "Post" ("id_post") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Lista_Post" (
    "id_lista" INTEGER NOT NULL,
    "id_post" INTEGER NOT NULL,

    PRIMARY KEY ("id_lista", "id_post"),
    CONSTRAINT "Lista_Post_id_lista_fkey" FOREIGN KEY ("id_lista") REFERENCES "Lista" ("id_lista") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Lista_Post_id_post_fkey" FOREIGN KEY ("id_post") REFERENCES "Post" ("id_post") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Lista_Post" ("id_lista", "id_post") SELECT "id_lista", "id_post" FROM "Lista_Post";
DROP TABLE "Lista_Post";
ALTER TABLE "new_Lista_Post" RENAME TO "Lista_Post";
...
CREATE TABLE "new_Post" (
    ...
    CONSTRAINT "Post_id_categoria_fkey" FOREIGN KEY ("id_categoria") REFERENCES "Categoria" ("id_categoria") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Puntuacion" (
    ...
    CONSTRAINT "Puntuacion_id_post_fkey" FOREIGN KEY ("id_post") REFERENCES "Post" ("id_post") ON DELETE CASCADE ON UPDATE CASCADE
);
