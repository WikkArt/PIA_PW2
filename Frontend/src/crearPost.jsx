...
function CrearPost() {
  ...
  return (
    <>
      ...
      <form
        id="idCrearPost"
        className={CrearPostCSS["crear-post"]}
        onSubmit={handleSubmit}
      >
        <div className={`${CrearPostCSS.col} ${CrearPostCSS["col-izq"]}`}>
          <img
            id="idPostSample"
            src="/Images/Templates/Post_Gray_16-9.png"
            className={CrearPostCSS["crear-post-pixel-corners"]}
            alt="Avatar"
          ></img>
          <input
            className={CrearPostCSS["form-control"]}
            type="file"
            id="btnAvatar"
            name="btnAvatar"
        ...
        <div className={`${CrearPostCSS.col} ${CrearPostCSS["col-der"]}`}>
          <div className={CrearPostCSS["regresar-titulo"]}>
            <Link
              to="/perfilUsuario"
              className={`${CrearPostCSS["regresar-elemento"]} ${CrearPostCSS["boton-pixel-corners"]}`}
            >
              <img
          ...
          <div className={CrearPostCSS.datos}>
            ...
            <button
              id="btnPublicar"
              type="submit"
              className={CrearPostCSS["boton-pixel-corners"]}
            >
              Publicar
            </button>
          </div>
