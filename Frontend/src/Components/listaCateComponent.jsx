function ListaCateComponent(props) {
    ...
    const { label, name, value, checked, onChange, dataBsToggle, dataBsTarget } = props
    ...
    return(
        <>
            <li className="list-group-item">
                ...
                <button id="btnInfoCategoria" className="btn btn-primary" data-bs-toggle={dataBsToggle} data-bs-target={dataBsTarget}>
