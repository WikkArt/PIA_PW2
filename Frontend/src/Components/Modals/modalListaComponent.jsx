...
function ModalListaComponent(props) {
  const { className, id, tabIndex, role, ariaHidden, lista, onPostClick } =
    props;
                ...
                <>
                  <div className="modal-header lista-header row">
                    <button
                      ...
                      data-bs-target="#idModalElimLista"
                      className="eliminar-icono circular-pixel-corners"
                    >
                      <img
                    ...
                    <div className="col fotos-container">
                      ...
                      <img
                        id="idFotoPerfilL"
                        src={
                          lista.usuario?.avatar
                            ? `http://localhost:3001${lista.usuario.avatar}`
                  ...
                  <div className="modal-body lista-body">
                    {lista.posts && lista.posts.length > 0 ? (
                      lista.posts.map((lp) => (
                        <div
                          className="lista-post"
                          key={`${lp.id_lista}_${lp.id_post}`}
                        >
                          <PostComponent
                            post={lp.post}
