function ModalElimComentarioComponent(props) {
                    ...
                    <form className="post-pixel-corners">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Eliminar Comentario</h5>
                            ...
                            <div className="modal-body">
                                <p>
                                    ¿Estás seguro de eliminar este comentario? Al presionar el 
                                    botón "Sí" ya no aparecerá dentro de la publicación.
                                </p>
                            </div>
...
export default ModalElimComentarioComponent