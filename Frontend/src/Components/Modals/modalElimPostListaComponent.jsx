function ModalElimPostListaComponent(props) {
                    ...
                    <form className="post-pixel-corners">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Eliminar Post de la Lista</h5>
                            ...
                            <div className="modal-body">
                                <p>
                                    ...
                                    botón "Sí" ya no aparecerá dentro de la lista
                                    "Título de la Lista".
                                </p>
                            </div>
                            <div className="modal-footer">
                                ...
                                <button type="button" className="dropdown-pixel-corners"
                                    data-bs-toggle="modal" data-bs-target="#idModalLista">
                                    No
                                </button>
                            </div>
                        </div>
...
export default ModalElimPostListaComponent