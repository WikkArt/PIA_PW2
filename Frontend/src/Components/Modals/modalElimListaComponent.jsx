function ModalElimListaComponent(props) {
                    ...
                    <form className="post-pixel-corners">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Eliminar Lista</h5>
                            ...
                            <div className="modal-body">
                                <p>
                                    ¿Estás seguro de eliminar esta lista? Al presionar el 
...
export default ModalElimListaComponent